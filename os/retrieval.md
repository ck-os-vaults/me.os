...
- **Write:** At a meaningful stopping point, record useful progress, confirmed facts or commitments, blockers, and where to resume. Skip routine tool activity, trivial exchanges, and unchanged status. Use one note per active day in the time zone recorded in [AGENTS.md](AGENTS.md); no idle-day filler or scheduled job is needed.
